...
<body>
    ...
    if (isset($_POST["submit_dangnhap"])) {
        if($_POST['user_dangnhap'] && $_POST['pass_dangnhap']){

            $username = addslashes($_POST['user_dangnhap']);
            $password = addslashes($_POST['pass_dangnhap']);
            include('ketnoi.php');
            ...
            if($username=='admin'){
                ...
                $query1 = mysql_query("select * from member where username='$username'");
                ...
                if($num_row1 >0){
                    ...
                    echo "<script>alert ('Tai khpan khong hop le')</script>";
                }
            }
        }
    }
        ...
        <div id="signupbox" style=" margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
            <div class="panel panel-info">
                ...
                <div class="panel-body" >
                    <form id="signupform" class="form-horizontal" role="form" action="xuly.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="address_dangki" placeholder="Địa chỉ" >
                            </div>
                        </div>
                        <div class="form-group">
                            <!-- Button -->     
